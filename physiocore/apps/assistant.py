...
from physiocore.lib.sound_utils import play_welcome_sound_blocking
...
def run_exercise_sequence():
    ...
    print(f"🎵 Welcome to PhysioPlus Exercise Sequence! (voice_mode: {voice_mode})")
    try:
        play_welcome_sound_blocking(voice_mode=voice_mode, enabled=voice_enabled)
